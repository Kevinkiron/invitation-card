...
const RULES = [
  ...
  /* Anniversaries are tested BEFORE weddings on purpose. "25th wedding
     anniversary" contains the word "wedding", so with the general rule
     first it classified as a wedding — and now that weddings route to the
     cinematic bride-and-groom interview, a couple married twenty-five
     years were asked for their wedding date and counted down to it. */
