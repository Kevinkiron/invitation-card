...
export const WEDDING_STEPS = [
  ...
  },
  {
    ...
    done: (t) => list(t?.media?.storyImages).length > 0,
    ask: (t) =>
  ...
  /* ── 8. Gallery ── */
  {
    ...
    done: (t) => list(t?.media?.galleryImages).length > 0,
    ask: () =>
  ...
  /* ── 10. The thank-you at the foot of the page ── */
  {
    ...
    group: "The thank-you",
    ack: true,
    unlocks: "the closing scene \u2014 your thank-you over a full-width photograph",
    done: (t) => has(t?.invitation?.thankYouNote) && Boolean(t?.media?.closingImage),
    ask: (t) =>
      has(t?.invitation?.thankYouNote)
        ? "One last photograph for behind the thank-you \u2014 something wide and warm."
        : "Last one \u2014 a thank-you line to close the page, and a photograph to sit behind it.",
  },
];
