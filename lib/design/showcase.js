...
/* ── The invitation wall ──────────────────────────────────────────────
   Twelve designs that drift past on the landing page, each one drawn by
   the real renderer. The point is range: a visitor should not be able to
   imagine one template underneath them. Deliberately spread across warm
   and cold, script and condensed, framed and frameless, light and dark.

   Compact on purpose — the wall shows only each invitation's hero, so
   these carry no `sections`. */
const wall = (key, label, design, content) => ({ key, label, design, content });

export const WALL = [
  ...SHOWCASE.map((s) => ({ key: s.key, label: s.label, design: s.design, content: s.content })),

  wall("housewarming", "A housewarming",
    {
  ...
  wall("baptism", "A baptism",
    {
      palette: { bg: "#f5f8fb", surface: "#e6eef6", ink: "#26364a", muted: "#7488a0", accent: "#6f93b8", accentSoft: "#c9dbea", deep: "#28405c", onDeep: "#f5f8fb" },
      fonts: T.serif, frame: "arch", motif: "geometric", density: 0.6, reveal: "none", corner: "soft",
      displayWeight: 700, h1Scale: 8.5, h1Max: 40, ornament: "&#10047;",
    },
    {
      epigraph: { text: "“Blessed beginnings.”" },
      heroPhoto: photo("#e6eef6", "#c9dbea", "#6f93b8"),
      kicker: "Holy Baptism", headline: "Baby Elias",
      subhead: "19th April · 9:30 AM", place: "St Thomas, Kottayam",
    }),

  wall("launch", "A product launch",
    {
      palette: { bg: "#101014", surface: "#191920", ink: "#d7d7de", muted: "#83838f", accent: "#ff6b35", accentSoft: "#3d2216", deep: "#ff6b35", onDeep: "#101014" },
      fonts: T.sans, frame: "none", motif: "geometric", density: 0.5, reveal: "none", corner: "sharp",
      displayWeight: 700, displayCase: "uppercase", h1Scale: 11, h1Max: 48, ornament: "&#9670;",
    },
    {
      kicker: "Launch night · Bengaluru", headline: "Halo One",
      subhead: "The first thing we have ever shipped", place: "Church Street",
    }),

  wall("anniversary", "A 25th anniversary",
    {
      palette: { bg: "#fbf7f7", surface: "#f4e9ea", ink: "#3f2c2f", muted: "#93787c", accent: "#a84b57", accentSoft: "#e8ccd0", deep: "#6b2b36", onDeep: "#fbf7f7" },
      fonts: T.script, frame: "arch", motif: "botanical", density: 0.85, reveal: "none", corner: "soft",
      displayWeight: 600, h1Scale: 9, h1Max: 42, ornament: "&#10047;",
    },
    {
      epigraph: { text: "“Twenty-five years, and counting.”" },
      heroPhoto: photo("#f4e9ea", "#e8ccd0", "#a84b57"),
      kicker: "Silver jubilee", headline: "George", headlineB: "Susan", joiner: "&", headlineScript: true,
      subhead: "9th January · 7:00 PM", place: "Kumarakom",
    }),

  wall("festival", "A music festival",
    {
      palette: { bg: "#04222a", surface: "#0a3540", ink: "#d8f2ef", muted: "#7fa9a8", accent: "#22e0b4", accentSoft: "#0f4a4a", deep: "#22e0b4", onDeep: "#04222a" },
      fonts: T.poster, frame: "none", motif: "waves", density: 1, reveal: "none", corner: "sharp",
      displayWeight: 400, displayCase: "uppercase", h1Scale: 15, h1Max: 58, ornament: "&#9650;",
    },
    {
      kicker: "Three days by the water", headline: "Backwater",
      subhead: "16–18 January · Gates 4 PM", place: "Alappuzha",
    }),

  wall("graduation", "A graduation",
    {
      palette: { bg: "#0f1320", surface: "#1a2033", ink: "#cfd6e8", muted: "#7d879f", accent: "#e0b44a", accentSoft: "#3a3320", deep: "#e0b44a", onDeep: "#0f1320" },
      fonts: T.serif, frame: "circle", motif: "rings", density: 0.55, reveal: "none", corner: "sharp",
      displayWeight: 700, h1Scale: 9, h1Max: 40, ornament: "&#9670;",
    },
    {
      heroPhoto: photo("#1a2033", "#3a3320", "#e0b44a"),
      kicker: "Class of 2027", headline: "Nikhil Menon",
      subhead: "Convocation · 28th June", place: "NIT Calicut",
    }),
];
